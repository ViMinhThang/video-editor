...
export class UploadService {
  static async handleUploadVideo(file: Express.Multer.File, project_id: number) {
  ...
  static async handleUploadImage(file: Express.Multer.File, project_id: number) {
  ...
  static async handleUploadSrt(file: Express.Multer.File, project_id: number, asset_id: number) {
